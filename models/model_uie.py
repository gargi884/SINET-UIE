...
class ModelPlain(ModelBase):
    ...
    def define_loss(self):
        ...
        if G_lossfn_type == 'uie':            
            from models.loss_uie import loss_uie
            self.G_lossfn = loss_uie().to(self.device)    
        else:
    ...
    def feed_data(self, data, need_GT=False, phase='test'):
        self.A = data['A'].to(self.device) #GT
        self.B = data['B'].to(self.device) #input image

    # ----------------------------------------
    # feed L to netG
    # ----------------------------------------
    def netG_forward(self, phase='test'):
        self.E = self.netG(self.B)
    ...
    def optimize_parameters(self, current_step):
        ...
        if G_lossfn_type in ['uie']:
            total_loss = self.G_lossfn(self.E, self.A)   
